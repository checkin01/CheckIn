			...
			<div id="ainfo" class="border w3-show" data-ride="carousel" style="padding:20px">
				...
				<div>
					<p id="notice">가평에 위치한 테라스 펜션은 무료 Wi-Fi 등 시설이 완비된 객실을 제공하며,
						...
						떨어져 있습니다. 원주공항까지의 거리는 61km입니다. 가평읍 지역은 음식, 로맨틱 휴가, 로맨틱 테마 여행을 원하시는
						분께 강력 추천하는 지역입니다. 고객님의 언어로도 지원됩니다!</p>
				</div>
			</div>
					...
					<div class="container font1-medium col-lg-8"
						...
						<div class="row">
							...
							<input type="button" value="예약하기"
								class="btn form-control col-sm-3 btn-success" />
						</div>
						<!-- 버튼 폼 끝 -->
