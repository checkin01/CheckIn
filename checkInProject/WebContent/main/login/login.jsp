...
<script>
	...
	$(function(){
		...
		$("#masterLoginBtn").click(function(){
			var result = logChk();
			if(result == true){
				location.href="<%=request.getContextPath()%>/master/manage/manageAccomodation.jsp";
			}
			return false;
		});
						...
						<div class="w3-section">
							...
							<div class="w3-section row">
								<button id="memberLoginBtn"
									...
									>일반 회원 로그인</button>
								<button id="masterLoginBtn"
									class="w3-button w3-block w3-deep-orange border w3-padding col-sm-6 rounded"
									>가맹점 회원 로그인</button>
							</div>
