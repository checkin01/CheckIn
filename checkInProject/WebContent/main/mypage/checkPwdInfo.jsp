...
-->
	<div id="main" class="row main">
		...
		<div class="col-sm-5 center container" id="center">
			...
			<hr />
			<h3>회원정보확인</h3>
			<span class="font1-small"> <span style="color: skyblue; font-weight: bold">회원님</span>의 정보를 안전하게 보호하기 위해 비밀번호를 다시 한번 확인 합니다.
			</span><br />
			<br />
					...
					<table class="table rounded" id="pwd-table">
						<thead class="rounded">
							<tr class="rounded">
								...
								<th><input class="input-control" type="password" id="pwd" /></th>
							</tr>
						</thead>
					</table>
				</div>
				<input type="submit" id="pwdChk" value="확인" class="btn btn-success" /> <input type="button" id="cancle" value="취소" class="btn " />
			</form>
