   ...
   <div id="main" class="row main">
      ...
      <div class="col-sm-7 center" id="center">
         <!--  check box 추가 -->
            ...
            <!-- 홈 > 회원가입 -->
            <hr>
            <h4 class= "font1-small">홈>로그인>마이페이지</h4>
            <hr>
            <form method="post" id="regFrm" class="form-horizontal"
               ...
               <div class="form-group row">
                  <label class="col-sm-2" >아이디</label> <input type="text"
                     name="userid" id="uid" class="form-control col-sm-10" 
                     disabled>
               </div>
               <div class="form-group row">
               ...
               <div class="form-group row">
                  <label class="col-sm-2">생년월일</label> <input type="date"
                     name="birthday" id="birth" class="form-control col-sm-7" disabled>
                     <div class="dropdown">
         ...
         <div class="form-group row">
                  <label class="col-sm-2">포인트</label> <input type="text"
                     name="username" id="uname" class="form-control col-sm-10"
                     disabled>
               </div>
