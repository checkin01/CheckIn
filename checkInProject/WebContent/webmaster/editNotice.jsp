...
<body>
	<div id="main" class="row main"
		...
		<div class="col-sm-8 center container" id="center">
			<div class="font1-small" style="padding:20px 0">
			<span> 공지 사항 > 공지 수정하기 </span>
			</div>
			<form id="dataform" class="form-horizontal font1-medium"
				...
				<div class="form-group" style="padding: 0 10px;">
					...
					<div class="form-control col-sm-5" id="ntitle" name="ntitle"
						class="edit">공지1</div>
				...
				<div class="form-group" style="padding: 0 10px;">
					...
					<textarea id="ncontent" name="ncontent" class="form-control edit"
				...
				<div class="form-group">
					...
					<div class="form-group col-sm-8 edit">
						<div class='input-group date' id='datetimepicker6'>
							<input type='text' class="form-control" value="2018-09-10 12:00" /> <span
				...
				<div class="form-group row">
					...
					<select class="form-control col-sm-5" id="ntype" style="width:50%">
						<option>일반 회원</option>
