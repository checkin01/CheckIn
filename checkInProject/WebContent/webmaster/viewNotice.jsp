		...
		<div class="col-sm-8 center" id="center">
			...
			<div class="font1-medium form-horizontal rounded" style="width:100%; hegith:100%" >
				...
				<div class=" row item" >
					...
					<div class="col-sm-8" id="ncontent">공지 사항 입니다..ㅀㅎ.</div>
				</div>
			...
			<div class="button-group">
				<button type="button" class="btn w3-indigo edit">수정하기</button>
				<button type="button" class="btn w3-indigo edit">삭제하기</button>
			</div>
		</div>
