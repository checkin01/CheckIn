...
-->	
	...
	<div id="main" class="row main">
		...
		<div class="col-sm-10 center" id="center">
			<div class="font1-large" style="padding: 20px 0; text-align: center">리뷰</div>
			<div class="list-group">
				...
				<form action="list.jsp" id="searchFrm" class="form-inline">
					<div class="list-group-item list-group-item-action" style="text-align: center">
						...
						</select> <input type="text" id="searchWord" name="searchWord" class="form-control" /> <input
							type="submit" value="Search" class="form-control" />
					</div>
