<%=request.getContextPath()%>/<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
		...
		<div class="col-sm-8 center" id="center" style="top: 50px">
			...
			<form id="dataform" class="form-horizontal font1-medium list-group" method="post" action="writeOk.jsp" enctype="multipart/form-data">
				...
				<div class="form-group row list-group-item">
					<i class="fa fa-fort-awesome"> <label for="typeSelector">숙박 업소 유형</label></i> <select class="form-control col-sm-5" id="typeSelector" name="">
						<option>호텔</option>
						<option>모텔</option>
						<option>펜션</option>
						<option>호스텔</option>
				...
				<!-- 숙박 업소 이름 -->
				<div class="form-group row list-group-item">
					<i class="fa fa-font-awesome"> <label for="aname">숙박 업소 이름</label></i> <input class="form-control col-sm-5" maxlength="20" id="aname" name="aname" type="text" /> <span class="error-text-box"
						id="anameMsg"></span>
				</div>
				...
				<div class="form-group row list-group-item">
					...
					<div class="input-group">
						<input type="text" id="addr" name="addr" class="form-control col-sm-8" readonly />
				...
				<!-- 숙박 업소 전화번호 -->
				<div class="form-group row list-group-item">
					<i class="fa fa-address-book"> <label>숙박 업소 전화번호</label></i> <input class="form-control col-sm-5" id="tel" name="tel" type="text" placeholder="예) 02-8888-7777" /> <span class="error-text-box"
						id="telMsg"></span>
				</div>
				...
				<div class="form-group row list-group-item">
					...
					<div>
						<span class="input-group"> <span class="form-control col-sm-5">check in</span> <input class="form-control col-sm-6 timepicki-input " id="checkin" name="checkin" type="text"
							value="03:00 PM" /> <span class="error-text-box" id="checkinMsg"></span>
						</span> <span class="input-group"> <span class="form-control col-sm-5">check out</span> <input class="form-control col-sm-6 timepicki-input" id="checkout" name="checkout" type="text"
							value="12:00 AM" /> <span class="error-text-box" id="checkoutMsg"></span>
						</span>
					</div>
				</div>
				...
				<div class="form-group row list-group-item">
					...
					<div>
						<span class="input-group"> <span class="form-control col-sm-6">손님이 최대 머무를 수 있는 일수</span> <input class="form-control col-sm-6" id="maxsleepdate" name="maxsleepdate" type="number"
							value="30" /> <span class="error-text-box" id="maxsleepdateMsg"></span>
						</span> <span class="input-group"> <span class="form-control col-sm-6">손님이 최대 예약 할 수 있는 일수</span> <input class="form-control col-sm-6" id="maxreservedate" name="maxreservedate" type="number"
							value="30" /> <span class="error-text-box" id="maxreservedateMsg"></span>
						</span>
					</div>
				</div>
				<!-- 이미지 등록 -->
				...
				<!-- 등록 버튼 -->
				<div class="list-group-item row">
					<input type="reset" value="다시 쓰기" class="btn btn-success form-control col-sm-3" /> <input type="button" value="돌아가기" class="btn btn-success form-control col-sm-3" /> <input type="submit"
						value="등록" class="btn btn-success form-control col-sm-3" />
				</div>
			</form>
			<!-- footer -->
