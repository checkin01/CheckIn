	...
	<div id="main" class="row main">
		...
		<div class="col-sm-8 center" id="center" style="top: 50px">
			...
			<form id="dataform" class="form-horizontal font1-medium list-group" method="post" action="writeOk.jsp" enctype="multipart/form-data">
				...
				<!-- 등록 버튼 -->
				<div class="list-group-item row">
					<input type="reset" value="다시 쓰기" class="btn btn-success form-control col-sm-3" /> <input type="reset" value="취소" class="btn btn-success form-control col-sm-3" /> <input type="submit"
						value="수정" class="btn btn-success form-control col-sm-3" />
				</div>
			</form>
			<!-- footer -->
