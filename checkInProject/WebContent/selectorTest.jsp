    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#location_pannel">
          	<span id="sido" name="sido">서울</span>
          	<span id="dong" name="dong">강남구</span>
          </a>
      ...
      <!-- panel body -->
        <div class="panel-body">
           ...
           <!-- 
           var locs2 = ['강남구','강동구','강북구','강서구','관악구','광진구','구로구','금청구','노원구','도봉구',
           '동대문구','동작구','마포구','서대문구','서초구','성동구','성북구','송파구','양천구','영등포구','용산구','은평구','종로구','중구','중랑구'];
            -->
           <hr/>
           <input type="button" class="select-btn" value="주소로 검색하기" ><input type="button" class="btn" value="인근 지하철로 검색하기">
           <div class="row" id="gu_panel" style="width:500px; padding:10px">
