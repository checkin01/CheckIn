					...
					<div class="form-group row" id="info">
						...
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="movie"> <span
									class="col-sm-3">무비</span>
							</div>
						</div>
						
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="와이파이"> <span
									class="col-sm-3">와이파이</span>
							</div>
						</div>
						
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="주차가능"> <span
									class="col-sm-3">주차가능</span>
							</div>
						</div>
						
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="수영장"> <span
									class="col-sm-3">수영장</span>
							</div>
						</div>
						...
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="식사가능"> <span
									class="col-sm-3">식사가능</span>
							</div>
						</div>

						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="흡연가능"> <span
									class="col-sm-3">흡연가능</span>
							</div>
						</div>
						
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="금연"> <span
									class="col-sm-3">금연</span>
							</div>
						</div>
						
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="베이비존"> <span
									class="col-sm-3">베이비존</span>
							</div>
						</div>
						
						<div class="input-group-prepend d-inline-flex p-3">
							<div class="input-group-text">
								<input type="checkbox" name="info" value="노래방"> <span
									class="col-sm-3">노래방</span>
							</div>
						</div>
