...
<link rel="stylesheet" href="<%=request.getContextPath()%>/master/css/default.css">
<script src="<%=request.getContextPath()%>/master/js/showDetailAccomodation.js"></script>
<!-- daterangepicker-->
<script src="<%=request.getContextPath()%>/master/js/daterangepicker.js"></script>
<script src="<%=request.getContextPath()%>/master/js/showDetailAccomodation.js"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/master/css/daterangepicker.css">
<style>
.roomsImg {
	margin-top: 20px;
	padding: 0px;
...
<body>
	...
	<div id="main" class="row main">
		<!-- 왼쪽 필터 부분 -->
		<aside class="left col-lg-1 font1-medium w3-container" id="left"></aside>
			...
			<div class="w3-show container" id="rooms">
				...
				<div class="border row">
					...
					<div style="width: 100%; padding: 10px; background: #e6ffe6;">
						...
						<div id="showReview" class="font1-medium btn btn-success" style="width: 100%; height: 30px"
							onclick="whenClickReview()">
						...
						<div class="container input-group" id="review" style="display: none; padding-top: 10px">
							...
							<div class="row">
								...
								<p class="col-sm-4">
									<img src="../img/accomodation/hotel03.PNG" style="width: 100%; height: 150px"
										class="rounded">
								</p>
							</div>
						</div>
